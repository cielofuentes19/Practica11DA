...
using Owin;
using InicioSesionGoogle.Models;
...
namespace InicioSesionGoogle
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                ClientId = "1470831496-ao5jg2iuqkhmasgjcbf4g8uuq22te39i.apps.googleusercontent.com",
                ClientSecret = "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"
            });
        }
    }
}